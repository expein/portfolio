...
const OptionNavbar= () => {
    return (
        <div className="flex items-center justify-end ml-auto">
            ...
            <button type="button" className="relative inline-flex items-center justify-center text-white transition-all duration-200  bg-palletTwoSecondary rounded-full w-9 h-9 md:w-12 md:h-12 hover:bg-palletTwoQuaternary hover:text-palletTwoSecondary">
