        ...
        <div className="fixed top-0 left-0 w-full z-50">
            <div className="w-full flex justify-center">
                <div className="w-full max-w-[1440px] text-white flex items-center justify-center p-[15px]">
                    <div className="w-full lg:w-1/2 flex justify-around items-center rounded-3xl p-[5px] bg-palletTwoSecondary gap-1">
                        ...
                        <div className="sm:hidden flex flex-col w-full">
                            <button onClick={() => setIsDropdownOpen(!isDropdownOpen)} className="text-white bg-palletTwoPrimary rounded-full h-8 sm:h-9 md:h-10">
                                Menu
                            </button>
